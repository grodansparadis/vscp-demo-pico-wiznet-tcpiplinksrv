...
git clone --recurse-submodules https://github.com/WIZnet-ioNIC/WIZnet-PICO-C fetch the Wiznet Ionic code. Already a submodule in this project.

## Notes on working with picoprobe on Ubuntu and Visual Studio Code

[This](https://www.youtube.com/watch?v=jnC5LrTx470&t=522) is an excellent document on how to setup the system for this.
